...
( function( factory ) {
    ...
    ( function( $ ) {
        ...
        var Selectlist = function( element, options ) {
            ...
            this.$element.on( 'click.fu.selectlist1', '.dropdown-menu a', $.proxy( this.itemClicked, this ) );
            this.setDefaultSelection();
        ...
        Selectlist.prototype = {
            ...
            itemClicked: function( e ) {
                ...
                this.$element.trigger( 'clicked.fu.selectlist1', this.$selectedItem );
            ...
            itemChanged: function( e ) {
                ...
                this.$element.trigger( 'changed.fu.selectlist1', data );
            },
