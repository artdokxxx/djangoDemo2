...
(function (factory) {
    ...
    var Repeater = function (element, options) {
        ...
        this.$filters1 = this.$element.find('.repeater-filters1');
        ...
        this.$filters1.on('changed.fu.selectlist1', function (e, value) {
            self.$element.trigger('filtered.fu.repeater', value);
            self.render({
                clearInfinite: true,
                pageIncrement: null
    ...
    Repeater.prototype = {
        ...
        destroy: function () {
            ...
            this.$element.find('.selectlist1').selectlist('destroy');
        ...
        getDataOptions: function (options) {
            ...
            opts.filter1 = (this.$filters1.length > 0) ? this.$filters1.selectlist('selectedItem') : {
                text: 'All',
                value: 'all'
            };
